        ...
        <el-card class="profile-card">
          ...
          <div class="profile-content">
            ...
            <el-descriptions :column="1" border class="profile-info">
              ...
              <el-descriptions-item label="所属企业">{{ profile.companyName || '-' }}</el-descriptions-item>
...
import { getRecruiterProfile, updateRecruiterProfile, changePassword as changePasswordApi, bindPhone as bindPhoneApi, bindEmail as bindEmailApi } from '@/api/recruiterProfile'
...
const saveProfile = async () => {
  ...
  try {
    await updateRecruiterProfile(profileForm.value)
...
const beforeAvatarUpload = (file) => {
  ...
  reader.onload = async (e) => {
    try {
      await updateRecruiterProfile({ avatar: e.target.result })
